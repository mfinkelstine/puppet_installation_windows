...
REMOTE_PATH = 'c:\\puppet_installation'
#REMOTE_PATH = 'C:\\python_scripts\\puppet_installation\\'
def main():
	ip 			= "9.151.184.47"
	domain 		= "ENG"
	username 	= "meirfi"
	...
	server = WindowsMachine(ip, passedUsername, password)
	print server.run_remote('hostname', async=False, output=True)
